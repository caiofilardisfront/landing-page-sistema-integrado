...
function updateSlider() {
    // 1. ESTA LINHA FALTAVA: Move o container para mostrar o slide correto
    track.style.transform = `translateX(-${currentSlide * 100}%)`;

    // 2. Atualiza as classes para ativar as animações internas (texto e zoom)
